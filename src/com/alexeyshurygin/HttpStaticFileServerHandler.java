...
public class HttpStaticFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    public static final Logger log = LogManager.getLogger(HttpStaticFileServerHandler.class);
    public static final String HTTP_DATE_FORMAT = "EEE, dd MMM yyyy HH:mm:ss zzz";
    public static final String HTTP_DATE_GMT_TIMEZONE = "GMT";
    public static final int HTTP_CACHE_SECONDS = 60;
    private final String path;
    private final File dir;
    //Alphanumeric banner ids.
    private static final Pattern pattern = Pattern.compile("/banner/([a-z0-9]+)");

    public HttpStaticFileServerHandler(final String path) {
        if (path == null)
        ...
        if (!dir.exists() || !dir.isDirectory()) {
            ...
            if (!success) {
                throw new IllegalArgumentException("Cannot create dir named " + path);
            }
        }
    }
    ...
    private String getId(final String uri) {
        log.debug("URI:{}", uri);
